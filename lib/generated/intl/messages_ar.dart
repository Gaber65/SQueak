...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "crNumber": MessageLookupByLibrary.simpleMessage("بيانات الصديق الصغير"),
    "createPetProfile": MessageLookupByLibrary.simpleMessage(
      "أنشئ ملف صديقك الصغير",
    ),
    ...
    "enterChatName": MessageLookupByLibrary.simpleMessage("أدخل اسم الدردشة"),
    ...
    "enterPetName": MessageLookupByLibrary.simpleMessage(
      "ادخل اسم الصديق الصغير",
    ),
    ...
    "health_tracking": MessageLookupByLibrary.simpleMessage(
      "تتبع الحالة الصحية",
    ),
    ...
    "missing_field_pet_name": MessageLookupByLibrary.simpleMessage(
      "اسم الصديق الصغير",
    ),
    "missing_field_photo": MessageLookupByLibrary.simpleMessage(
      "صورة الملف الشخصي",
    ),
    "missing_field_species": MessageLookupByLibrary.simpleMessage(
      "النوع الحيواني",
    ),
    ...
    "noActiveChats": MessageLookupByLibrary.simpleMessage(
      "لا توجد دردشات نشطة",
    ),
    "noAppointment": MessageLookupByLibrary.simpleMessage("لا توجد مواعيد"),
    "noBlockedChats": MessageLookupByLibrary.simpleMessage(
      "لا توجد دردشات محظورة",
    ),
    "noChatsFound": MessageLookupByLibrary.simpleMessage(
      "لم يتم العثور على دردشات",
    ),
    "noChatsInThisCategory": MessageLookupByLibrary.simpleMessage(
      "لا توجد دردشات في هذه الفئة",
    ),
    "noChatsYet": MessageLookupByLibrary.simpleMessage(
      "لا توجد محادثات حتى الآن!",
    ),
    "noCompletedChats": MessageLookupByLibrary.simpleMessage(
      "لا توجد دردشات مكتملة",
    ),
    "noMatingChats": MessageLookupByLibrary.simpleMessage(
    ...
    "noSentRequests": MessageLookupByLibrary.simpleMessage(
      "لا توجد طلبات صادرة",
    ),
    ...
    "petDeletedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "تم حذف الصديق الصغير بنجاح",
    ),
    "petDetails": MessageLookupByLibrary.simpleMessage("بيانات الصديق الصغير"),
    ...
    "pet_friendship": MessageLookupByLibrary.simpleMessage(
      "صداقة الأصدقاء الصغار",
    ),
    ...
    "showAllChats": MessageLookupByLibrary.simpleMessage("عرض جميع الدردشات"),
    ...
    "single_desc": MessageLookupByLibrary.simpleMessage("غير مهتم بالتزاوج"),
    ...
    "switchTitle": MessageLookupByLibrary.simpleMessage("أولاً بدل ملف الشخصي"),
    ...
    "unblockChat": MessageLookupByLibrary.simpleMessage("إلغاء حظر الدردشة"),
