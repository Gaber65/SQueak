...
class _ReactionDetailsSheetState extends State<ReactionDetailsSheet>
    ...
    return Tab(
      ...
      child: Padding(
        ...
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Image.asset(getReactionIcon(type), width: 24, height: 24),
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<PostCubit>()..getAllReactions(widget.postId),
    ...
    if (reactions.isEmpty) {
      return Center(
        child: Column(
          ...
          children: [
            Icon(Icons.sentiment_neutral, size: 64, color: Colors.grey[300]),
