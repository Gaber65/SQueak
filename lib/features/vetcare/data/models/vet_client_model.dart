...
class ClientModel extends ClientEntity {
  const ClientModel({required super.name, required super.description});
...
class SpecieModel extends SpecieEntity {
  const SpecieModel({required super.arType, required super.enType});

  factory SpecieModel.fromJson(Map<String, dynamic> json) =>
      SpecieModel(arType: json["arType"] ?? '', enType: json["enType"] ?? '');
