...
class DeleteCommentPostUseCase extends BaseUseCase<CommentEntity, CreateCommentParameters> {
  final BaseCommentRepository baseCommentRepository;

  DeleteCommentPostUseCase(this.baseCommentRepository);

  @override
  Future<Either<Failure, CommentEntity>> call(CreateCommentParameters parameters)async {
