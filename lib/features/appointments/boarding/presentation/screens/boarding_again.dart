...
class _BoardingAgainState extends State<BoardingAgain> {
  ...
  @override
  void initState() {
    entryDateTime = DateTime.parse(widget.entry.entryDate);
    exitDateTime = DateTime.parse(widget.entry.existDate);
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          BoardingCubit()..getBoardingType(widget.entry.clinicCode),
                          ...
                          : () {
                              if (selectedBoardingType != null) {
                                ...
                                cubit.editBoarding(
                                  ...
                                  entryDate: entryDate,
                                  existDate: exitDate,
                                  period: calculateDifference(entryDate, exitDate).inDays,
                                  comment: commentController.text,
                                  boardingTypeId: selectedBoardingType!.id,
                                  vetICarePetId: widget.entry.petId,
                                  context: context,
                                  boardingStatus: BoardingStatus.reserved.index,
                                );
                              } else {
                                infoToast(
                                    context,
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: PopupMenuButton<ClinicBoardEntity>(
                                  ...
                                  itemBuilder: (context) =>
                                      cubit.dummyClinicBoardEntities.map(
                                    (e) {
